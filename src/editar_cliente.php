...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        $direccion = $_POST['direccion'];
            $sql_update = mysqli_query($conexion, "UPDATE id_cliente SET nombre = '$nombre' , telefono = '$telefono', direccion = '$direccion' WHERE id_cliente = $idcliente");
...
$sql = mysqli_query($conexion, "SELECT * FROM cliente WHERE id_cliente = $id_cliente");
