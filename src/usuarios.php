...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['clave']) || empty($_POST['Fecha']|| empty($_POST['Imagen']))) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO usuario(nombre,correo,usuario,clave,Fecha) values ('$nombre', '$email', '$user', '$clave','$Fecha')");
            if ($query_insert) {
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="Fecha" class="form-control" placeholder="Ingrese Fecha" name="Fecha" id="Fecha">
                    </div>
                    <div class="form-group">
                        <label for="Imagen">$Imagen</label>
                        <input type="Imagen" class="form-control" placeholder="Ingrese Imagen" name="Imagen" id="Imagen">
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($data['estado'] == 1) { ?>
                                <a href="rol.php?id=<?php echo $data['id_usuario']; ?>" class="btn btn-warning"><i class='fas fa-key'></i></a>
