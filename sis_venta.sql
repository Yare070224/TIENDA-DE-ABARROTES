...
INSERT INTO `cliente` (`idcliente`, `nombre`, `telefono`, `direccion`, `id_usuario`, `estado`) VALUES
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `correo`, `usuario`, `clave`, `estado`) VALUES
