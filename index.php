<?php
session_start();
//En este apartado encontramos las funciones de localizacion del index
if (!empty($_SESSION['active'])) {
    header('location: src/');
} else {
    if (!empty($_POST)) {
        $alert = '';
//En este apartado estamos ucupando las variables de usuario y la clave de acceso para poder ingresar
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            $alert = '<div class="alert alert-danger" role="alert">
            Ingrese su usuario y su clave
            </div>';
        } else {
//En este aprtado tenemos la declaracion de codigo que tiene enlace con la "conexion" para que pueda tener funconamiento y aqui mismo tenemos el usuario y la clave de acceso
            require_once "conexion.php";
            $user = mysqli_real_escape_string($conexion, $_POST['usuario']);
            $clave = mysqli_real_escape_string($conexion, $_POST['clave']);
            echo("Hola".$clave);
//En este apartado tenemos la conexion de bases de datos y las primeras tablas que creamos
            ...
            if ($resultado > 0) {
                ...
                $_SESSION['Fecha'] = $dato['Fecha'];
//En este apartado tenemos el apartado de error  
                header('location: src/');
            } else {
                $alert = '<div class="alert alert-danger" role="alert">
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets\img\astr.png" width="300">
...
<a href="wwww.google.com">ir a google</a>
